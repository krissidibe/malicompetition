    ...
    <div className={`bg-gray-100 md:w-[260px] w-full ${canClose  ? "" : "hidden"} md:flex  flex flex-col h-screen transition-all ease-in-out p-4 `}>
     ...
     <Image
      ...
      <div className="flex flex-col mt-[30px] flex-1   ">
        ...
        <NavItem key={1} handleClick={handleClick} name="Tableau de bord"  href="/user" Icon={HomeIcon} />
        <NavItem key={2} handleClick={handleClick} name="Concours" href="/user/competitions"  Icon={BookOpenIcon} />
        <NavItem key={3} handleClick={handleClick} name="Candidatures" href="/user/candidatures"  Icon={AcademicCapIcon} />
        <NavItem key={4} handleClick={handleClick} name="Profile" href="/user/profile" Icon={UserIcon}  />
